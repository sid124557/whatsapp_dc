...
public final class C51872kW {
    public final SpannableString A00;
    public final boolean A01;

    public boolean equals(Object obj) {
        if (this != obj) {
            if (obj instanceof C51872kW) {
                C51872kW r5 = (C51872kW) obj;
    ...
    public C51872kW(SpannableString spannableString, boolean z) {
        this.A01 = z;
    ...
    public String toString() {
        ...
        A0o.append("InstallmentData(shouldShowInstallmentData=");
        A0o.append(this.A01);
        A0o.append(", installmentContent=");
