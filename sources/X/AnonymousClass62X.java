...
public final class AnonymousClass62X extends C829045j implements AnonymousClass4GQ {
    public final /* synthetic */ UpdatesAdapter this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public AnonymousClass62X(UpdatesAdapter updatesAdapter) {
        super(1);
            ...
            if (observableRecyclerView == null || (layoutManager = observableRecyclerView.getLayoutManager()) == null) {
                ...
                for (int i2 = 0; i2 < A08; i2++) {
                    ...
                    if (A0Q != null) {
                        ...
                        if ((tag instanceof C986452r) && ((C986452r) tag).A05) {
                            arrayList.add(A0Q);
