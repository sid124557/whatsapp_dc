...
public final class AnonymousClass4r2 extends C100425Aw {
    public final int A00;
    public final int[] A01;

    public AnonymousClass4r2(int[] iArr, int i) {
    ...
    public boolean equals(Object obj) {
        if (this != obj) {
            if (AnonymousClass4r2.class.equals(C86644Kx.A0e(obj))) {
    ...
    public String toString() {
        ...
        A0o.append("ShowSkinToneTip(emoji=");
