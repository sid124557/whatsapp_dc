...
public final class C90594hp extends C22731Pw {
    public final C53122ma A00;

    public Drawable B8D(Context context, C620733j r3) {
        C162457s7.A0J(context, 0);
        return AnonymousClass0RP.A00(context, R.drawable.vec_ic_positive_bot_feedback);
    }
    ...
    public C90594hp(C56722sS r1, C53122ma r2, C53202mi r3, C53322mu r4) {
        super(r1, r3, r4);
