...
public final class AnonymousClass1TQ extends AnonymousClass26T {
    ...
    public AnonymousClass1TQ(Bitmap bitmap, C41552Kr r3, List list, int i, boolean z) {
    ...
    public boolean equals(Object obj) {
        if (this != obj) {
            if (obj instanceof AnonymousClass1TQ) {
                AnonymousClass1TQ r5 = (AnonymousClass1TQ) obj;
