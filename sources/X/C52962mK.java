...
public final class C52962mK {
    ...
    public boolean equals(Object obj) {
        if (this != obj) {
            if (obj instanceof C52962mK) {
                C52962mK r5 = (C52962mK) obj;
    ...
    public C52962mK(Integer num, PublicKey publicKey, X509Certificate x509Certificate, X509Certificate x509Certificate2) {
    ...
    public String toString() {
        ...
        A0o.append("SupportCertificate(encryptionCertificate=");
        A0o.append(this.A02);
