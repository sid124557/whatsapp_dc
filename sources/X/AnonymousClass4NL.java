...
public class AnonymousClass4NL extends View.BaseSavedState {
    public static final Parcelable.Creator CREATOR = new AnonymousClass91V(86);
    public int A00 = -1;
    public int A01;
    public int A02;
    public int A03;
    ...
    public AnonymousClass4NL(Parcel parcel) {
        super(parcel);
    ...
    public AnonymousClass4NL(Parcelable parcelable) {
        super(parcelable);
    }
}
