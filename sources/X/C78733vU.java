...
public final class C78733vU extends C829045j implements AnonymousClass4GP {
    public final /* synthetic */ AnonymousClass33H this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public C78733vU(AnonymousClass33H r2) {
        super(0);
        this.this$0 = r2;
    }
    ...
    public /* bridge */ /* synthetic */ Object invoke() {
        ...
        while (A0q.hasNext()) {
            ...
            if (((AnonymousClass4G3) A0w.getValue()).B88() == AnonymousClass21E.E2E_MESSAGE) {
        ...
        while (A0q2.hasNext()) {
            ...
            if (A0w2.getValue() instanceof AnonymousClass3PA) {
        ...
        while (A0q3.hasNext()) {
            ...
            C162457s7.A0K(value, "null cannot be cast to non-null type com.whatsapp.historysync.integration.deserialization.HistorySyncE2eMessageParser");
            A0I.add(new C51742kJ((AnonymousClass3PA) value, A06));
        }
        LinkedHashMap A0C = C18330xA.A0C(C57692u3.A01(A0I));
        Iterator it = A0I.iterator();
        while (it.hasNext()) {
            Object next = it.next();
            AnonymousClass0x2.A1H(next, A0C, ((C51742kJ) next).A00);
        }
        return A0C;
    }
}
