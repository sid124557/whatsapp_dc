...
public class C172298Kl implements Externalizable {
    ...
    public List leadingDigitsPattern_ = AnonymousClass001.A0s();
    ...
    public void writeExternal(ObjectOutput objectOutput) {
        ...
        for (int i = 0; i < size; i++) {
            objectOutput.writeUTF(AnonymousClass001.A0n(this.leadingDigitsPattern_, i));
        }
