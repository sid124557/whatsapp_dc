...
public final class AnonymousClass3YH implements C84314Bw {
    ...
    public boolean AxE(AnonymousClass2PJ r9, C833648c r10, C833748d r11) {
        ...
        int i = AnonymousClass0x2.A0F(r3).getInt("privacy_groupadd", 0);
        long A0A = AnonymousClass0x2.A0A(AnonymousClass0x2.A0F(r3), "privacy_tip_exit_group_timestamp");
        if (((int) A0A) == -1) {
            return false;
        }
        long j = A0A + millis;
    ...
    public AnonymousClass3YH(C380625j r1, AnonymousClass33p r2, AnonymousClass1VX r3) {
