...
public final class C171658Hx implements C203499no {
    public AnonymousClass4FV A00;
    public C153087ae A01;
    public AnonymousClass9TD A02;

    public void A00(AnonymousClass303 r3, Integer num, String str, String str2, int i) {
        C162457s7.A0J(str, 2);
        C134246ig B0d = B0d();
        C134246ig.A00(B0d, num, str, i);
        if (str2 != null) {
            B0d.A0a = str2;
        }
        AnonymousClass6C8.A11(B0d, r3);
        this.A00.BhD(B0d);
    }

    public void A01(AnonymousClass303 r3, Integer num, String str, String str2, String str3, String str4, int i, boolean z) {
        C162457s7.A0J(str, 2);
        C134246ig B0d = B0d();
        C134246ig.A00(B0d, num, str, i);
        if (str2 != null) {
    ...
    public /* bridge */ /* synthetic */ void BKF(AnonymousClass303 r10, Integer num, Integer num2, String str, String str2, String str3, String str4, boolean z, boolean z2) {
    ...
    public C171658Hx(AnonymousClass4FV r1, C153087ae r2, AnonymousClass9TD r3) {
    ...
    public /* bridge */ /* synthetic */ void BKE(AnonymousClass303 r7, Integer num, Integer num2, String str, String str2) {
