...
public final class C159207lN {
    ...
    public static String A00(String str, String str2) {
        ...
        int[] A022 = A02(str);
        if (A02[3] == 0) {
            A0o.append(str, 0, A022[3]);
            return AnonymousClass000.A0X(str2, A0o);
        } else if (A02[2] == 0) {
            A0o.append(str, 0, A022[2]);
            return AnonymousClass000.A0X(str2, A0o);
        } else {
            int i = A02[1];
            if (i != 0) {
                ...
                A0o.append(str, 0, i2);
                A0o.append(str2);
                return A01(A0o, A02[1] + i2, i2 + A02[2]);
            } else if (str2.charAt(i) == '/') {
                A0o.append(str, 0, A022[1]);
                A0o.append(str2);
                int i3 = A022[1];
                return A01(A0o, i3, A02[2] + i3);
            } else {
                int i4 = A022[0] + 2;
                int i5 = A022[1];
                if (i4 >= i5 || i5 != A022[2]) {
                    ...
                    A0o.append(str, 0, i5);
                    A0o.append(str2);
                    return A01(A0o, A022[1], i5 + A02[2]);
                }
                A0o.append(str, 0, i5);
                A0o.append('/');
                A0o.append(str2);
                int i6 = A022[1];
                return A01(A0o, i6, A02[2] + i6 + 1);
            }
        }
    }
}
