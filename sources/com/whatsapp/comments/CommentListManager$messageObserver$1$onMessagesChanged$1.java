...
public final class CommentListManager$messageObserver$1$onMessagesChanged$1 extends C75003pT implements AnonymousClass4GR {
    public final /* synthetic */ Collection $messages;
    public int label;
    public final /* synthetic */ C60332yN this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public CommentListManager$messageObserver$1$onMessagesChanged$1(C60332yN r2, Collection collection, C84814Du r4) {
        super(r4, 2);
        this.this$0 = r2;
    ...
    public final Object A09(Object obj) {
        ...
        if (this.label == 0) {
            ...
            do {
                ...
                if (collection == null || C75003pT.A06(value, sortedSet, new C823343e(r5, collection), r4)) {
                }
                value = r4.getValue();
                sortedSet = (SortedSet) value;
                break;
            } while (C75003pT.A06(value, sortedSet, new C823343e(r5, collection), r4));
            return C59022wD.A00;
        }
