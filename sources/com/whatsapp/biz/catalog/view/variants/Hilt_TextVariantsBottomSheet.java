...
public abstract class Hilt_TextVariantsBottomSheet extends WDSBottomSheetDialogFragment {
    ...
    public void A1R() {
        if (!this.A02) {
            ...
            C64333Db r1 = r3.A1B;
            C107695bk.AFg(r1.A00, textVariantsBottomSheet);
            textVariantsBottomSheet.A01 = (AnonymousClass7CR) r3.A0v.get();
            textVariantsBottomSheet.A02 = new AnonymousClass7RX();
            textVariantsBottomSheet.A04 = C64333Db.A2t(r1);
        }
    }
