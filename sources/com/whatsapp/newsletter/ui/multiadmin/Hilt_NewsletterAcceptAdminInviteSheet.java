...
public abstract class Hilt_NewsletterAcceptAdminInviteSheet extends WDSBottomSheetDialogFragment {
    ...
    public void A1R() {
        if (!this.A02) {
            ...
            C107695bk r1 = r2.A00;
            C107695bk.AFg(r1, newsletterAcceptAdminInviteSheet);
            newsletterAcceptAdminInviteSheet.A06 = C64333Db.A2p(r2);
            newsletterAcceptAdminInviteSheet.A00 = C64333Db.A04(r2);
            newsletterAcceptAdminInviteSheet.A01 = C64333Db.A06(r2);
            newsletterAcceptAdminInviteSheet.A07 = (NewsletterLinkLauncher) r2.ANn.get();
            newsletterAcceptAdminInviteSheet.A08 = (AnonymousClass5QK) r1.A7w.get();
            newsletterAcceptAdminInviteSheet.A09 = (C103615Nr) r1.A7y.get();
        }
    }
