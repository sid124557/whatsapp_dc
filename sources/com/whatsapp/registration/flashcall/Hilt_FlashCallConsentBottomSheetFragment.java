...
public abstract class Hilt_FlashCallConsentBottomSheetFragment extends WDSBottomSheetDialogFragment {
    ...
    public void A1R() {
        if (!this.A02) {
            ...
            C64333Db r1 = r0.A1B;
            C64333Db.AdM(r1, flashCallConsentBottomSheetFragment);
            flashCallConsentBottomSheetFragment.A01 = r0.A18.AD4();
            flashCallConsentBottomSheetFragment.A00 = (AnonymousClass1VW) r1.A03.get();
        }
    }
