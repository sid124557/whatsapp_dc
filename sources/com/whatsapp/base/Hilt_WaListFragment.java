...
public abstract class Hilt_WaListFragment extends ListFragment implements AnonymousClass4GJ {
    ...
    public void A1J() {
        if (!this.A02) {
            this.A02 = true;
            ((WaListFragment) this).A00 = ((C88854au) ((AnonymousClass3DY) generatedComponent())).A1B.A00.ANI();
        }
    }
