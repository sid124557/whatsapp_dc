...
public abstract class Hilt_CatalogSearchFragment extends WaFragment {
    ...
    public void A1H() {
        if (!this.A02) {
            ...
            C107695bk r1 = r2.A00;
            C107695bk.AFP(r1, catalogSearchFragment);
            catalogSearchFragment.A0G = C86614Ku.A0T(r2);
            catalogSearchFragment.A0H = C64333Db.A2t(r2);
            catalogSearchFragment.A0J = C64333Db.A8y(r2);
            catalogSearchFragment.A0D = (AnonymousClass5MJ) r1.A9Q.get();
            catalogSearchFragment.A0E = new AnonymousClass5AO();
            catalogSearchFragment.A0C = C86654Ky.A0S(r2);
            catalogSearchFragment.A0B = C86624Kv.A0K(r2);
        }
    }
