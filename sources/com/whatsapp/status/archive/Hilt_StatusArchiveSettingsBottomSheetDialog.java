...
public abstract class Hilt_StatusArchiveSettingsBottomSheetDialog extends WDSBottomSheetDialogFragment {
    ...
    public void A1R() {
        if (!this.A02) {
            ...
            C88854au r0 = (C88854au) C18310x6.A0O(this);
            C64333Db r1 = r0.A1B;
            C64333Db.AdM(r1, statusArchiveSettingsBottomSheetDialog);
            statusArchiveSettingsBottomSheetDialog.A00 = (AnonymousClass2D4) r0.A0z.get();
            statusArchiveSettingsBottomSheetDialog.A01 = C64333Db.A4H(r1);
        }
    }
