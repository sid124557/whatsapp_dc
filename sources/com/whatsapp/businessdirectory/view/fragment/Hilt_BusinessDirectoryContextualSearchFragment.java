...
public abstract class Hilt_BusinessDirectoryContextualSearchFragment extends C08310eF implements AnonymousClass4GJ {
    ...
    public void A1G(Context context) {
        ...
        if (!this.A02) {
            this.A02 = true;
            ((C88854au) ((AnonymousClass3DY) generatedComponent())).A7v((BusinessDirectoryContextualSearchFragment) this);
        }
    }
