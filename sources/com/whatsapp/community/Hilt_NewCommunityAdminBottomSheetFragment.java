...
public abstract class Hilt_NewCommunityAdminBottomSheetFragment extends RoundedBottomSheetDialogFragment {
    ...
    public void A1R() {
        if (!this.A02) {
            ...
            C107695bk r1 = r2.A00;
            C107695bk.AFL(r1, r1, newCommunityAdminBottomSheetFragment);
            newCommunityAdminBottomSheetFragment.A02 = C64333Db.A4B(r2);
            newCommunityAdminBottomSheetFragment.A03 = C18280x3.A0Q(r1);
            newCommunityAdminBottomSheetFragment.A00 = (AnonymousClass5X8) r2.Aac.get();
            newCommunityAdminBottomSheetFragment.A01 = new AnonymousClass4UI(C86654Ky.A0W(r2));
        }
    }
