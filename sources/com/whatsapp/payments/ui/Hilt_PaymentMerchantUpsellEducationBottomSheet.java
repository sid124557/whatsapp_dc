...
public abstract class Hilt_PaymentMerchantUpsellEducationBottomSheet extends WDSBottomSheetDialogFragment {
    ...
    public void A1R() {
        if (!this.A02) {
            ...
            C107695bk r1 = r0.A00;
            C18300x5.A1D(r1, paymentMerchantUpsellEducationBottomSheet);
            paymentMerchantUpsellEducationBottomSheet.A01 = C1899593h.A0I(r0);
            paymentMerchantUpsellEducationBottomSheet.A00 = (AnonymousClass5NS) r1.A7O.get();
        }
    }
