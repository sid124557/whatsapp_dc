...
public abstract class Hilt_BkBottomSheetContentFragment extends BkFragment implements AnonymousClass4GJ {
    ...
    public void A1G(Context context) {
        ...
        if (!this.A02) {
            this.A02 = true;
            ((C88854au) ((AnonymousClass3DY) generatedComponent())).A8G((BkBottomSheetContentFragment) this);
        }
    }
